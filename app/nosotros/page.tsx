    ...
    <main className="flex min-h-screen flex-col bg-[#f7f3e6]">
      <section className="py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-['HelveticaBlack'] text-center mb-12 text-[#09465b]">Nosotros</h1>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-16">
            <div>
              <h2 className="text-2xl font-['HelveticaBlack'] mb-4 text-[#09465b]">Nuestra Historia</h2>
              <p className="text-[#09465b]/80 font-['HelveticaRoman'] mb-4">
                Fundada en 20010, nuestra clínica veterinaria nació con la misión de proporcionar atención médica de
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-16">
            ...
            <div>
              <h2 className="text-2xl font-['HelveticaBlack'] mb-4 text-[#09465b]">Nuestra Misión</h2>
              <p className="text-[#09465b]/80 font-['HelveticaRoman'] mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-2xl font-['HelveticaBlack'] mb-4 text-[#09465b]">Nuestra Visión</h2>
              <p className="text-[#09465b]/80 font-['HelveticaRoman'] mb-4">
