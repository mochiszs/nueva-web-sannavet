    ...
    <main className="flex min-h-screen flex-col bg-[#f7f3e6]">
      <section className="py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-['HelveticaBlack'] text-center mb-12 text-[#09465b]">Nuestros Servicios</h1>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="p-4 flex justify-center">
                  <h2 className="text-xl font-['HelveticaBold'] text-[#f7f3e6]">{service.title}</h2>
                </div>
              </div>
            ))}
          </div>
      ...
      {selectedService && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-[#f7f3e6] rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <h2 className="text-2xl font-['HelveticaBlack'] text-[#09465b] mb-4">{selectedService.title}</h2>
              <p className="text-[#09465b]/80 font-['HelveticaRoman'] mb-6">{selectedService.description}</p>
              <Button
                onClick={() => handleWhatsAppService(selectedService.title)}
                className="bg-green-500 hover:bg-green-600 text-white w-full py-2 rounded-md font-['HelveticaBold']"
              >
