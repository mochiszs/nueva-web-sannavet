    ...
    <footer className="bg-[#09465b] text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-['HelveticaBlack'] mb-4">Ubicación</h3>
            <div className="flex items-start mb-3">
              <MapPin className="mr-2 h-5 w-5 flex-shrink-0 mt-1" />
              <p className="font-['HelveticaRoman']">Av. 13 de Enero 2201 La Huayrona, SJL - Lima</p>
            </div>
            <div className="mt-6">
              <Link
                href="/libro-reclamaciones"
                className="flex items-center hover:text-[#f7f3e6] transition-colors font-['HelveticaRoman']"
              >
          ...
          <div>
            <h3 className="text-xl font-['HelveticaBlack'] mb-4">Horario de Atención</h3>
            <div className="flex items-start mb-3">
              <Clock className="mr-2 h-5 w-5 flex-shrink-0 mt-1" />
              <div className="font-['HelveticaRoman']">
                <p>Lunes a Sabado: 9:00 am - 8:00 pm</p>
          ...
          <div>
            <h3 className="text-xl font-['HelveticaBlack'] mb-4">Síguenos</h3>
        ...
        <div className="border-t border-gray-600 mt-8 pt-6 text-center text-sm font-['HelveticaRoman']">
